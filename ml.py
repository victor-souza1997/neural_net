...
excel_file_path = 'data.trajeto.csv'
...
required_columns = ['abs.angle', 'rel.angle', 'DuracaodoTrecho', 'Velocidade_km_h', 'vel.cal', 'Dif.Vel', 'cluster']
...
y = excel_data['output_cluster']       # Target variable
